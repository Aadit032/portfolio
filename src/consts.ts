export const SITE_TITLE = 'Aadit Suryawanshi';
...
export const SOCIAL_LINKS = [
	...
	{ label: 'Hugging Face', href: 'https://huggingface.co/Aadit-032', icon: 'huggingface' },
	{ label: 'Twitter', href: 'https://x.com/Aadit_032', icon: 'twitter' },
] as const;
